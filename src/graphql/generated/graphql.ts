...
export type FindManyPublicOfferingExtensionByAdminQuery = { findManyPublicOfferingExtensionByAdmin: { totalCount: number, publicOfferingExtensions: Array<{ originEndedAt: any, newEndedAt: any, createdAt: any, admin: { name: string } }> } };
